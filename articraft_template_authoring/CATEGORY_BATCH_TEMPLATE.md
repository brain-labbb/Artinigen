...
- 拓扑多样性审计必须包含 Procedural Sampling / Sweep Plan，说明 deterministic procedural sampling、compatibility matrix / gating、可选 regression overrides、random sweep seed 范围和 `module_topology_diversity` 预期。
