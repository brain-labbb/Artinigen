...
预计 `module_topology_diversity` 门控（>=10 distinct）能否过：yes。理由：tilting meridian vs fixed meridian vs no-ring pedestal vs wall arm vs date ring/top support stages produce distinct joint graphs.
