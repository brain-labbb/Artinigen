...
总组合数：`4 support × 4 wheel × 5 control = 80`。预计 `module_topology_diversity` 门控（>=10 distinct）能过：yes，control slot alone changes FIXED/none, PRISMATIC, and REVOLUTE child patterns.
